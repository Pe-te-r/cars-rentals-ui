...
const UsersTableContainer = () => {
  ...
  const [updateUser,{data:updateData,isSuccess:updateSuccess,isLoading:updateLoading}] = useUpdateUserMutation();
  ...
  useEffect(()=>{
    if(updateSuccess && updateData.message =='updated'){
      setEditableRowId(-1);
      refetch();
  ...
  return (
    <>
      ...
      {editableRowId > 0 && (
        <DynamicForm heading='Edit user' handleCancelClick={handleCancelClick} updateLoading={updateLoading} handleSaveClick={handleSaveClick} shareFunctions={shareUpdateFunctionality} />
      )}
