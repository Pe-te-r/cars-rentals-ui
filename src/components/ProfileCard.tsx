...
const ProfileCard = ({isProfileVisible,toggleProfileVisibility}: profileType) => {
  ...
  return (
    <div className="relative">
      ...
      {isProfileVisible && (
        <div className="absolute top-12 right-0 bg-gray-800 text-white p-4 rounded-lg shadow-lg w-64 p-2">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-sm m-1 text-gray-500">{user?.contact_phone}</p>
            </div>
          </div>
          <button
